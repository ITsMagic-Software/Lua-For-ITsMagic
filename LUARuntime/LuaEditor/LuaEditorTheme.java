...
public class LuaEditorTheme { 
  ...
  public TextScriptingTheme get(){
    if (theme == null){
      ...
      // optional, config colors
      theme.textColor = new Color("#ABB7C5");
      theme.backgroundColor = new Color("#1f1f1f");
      ...
      theme.selectedLineColor = new Color("#3A3A3A");
      ...
      theme.operatorColor = new Color("#D2CEB0");
      theme.keywordColor = new Color("#EC7600");
      theme.typeColor = new Color("#3CDFFF");
